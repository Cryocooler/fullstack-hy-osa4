...
describe('Maximum likes', () => {
  ...
  test('When list has blogs with same number of likes, return at least one list', () => {
    const duplicateList = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
    ...
    const result = listHelper.favoriteBlog(duplicateList);
    // console.log(result);
    expect(result).toEqual(expect.not.arrayContaining(duplicateList));
  });
});
